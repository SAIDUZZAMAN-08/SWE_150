...
bool initObstacles() {
    ...
    obstacles[0].rect = {SCREEN_WIDTH / 2 - 180, SCREEN_HEIGHT / 2-200, 400, 15};
    obstacles[1].rect = {SCREEN_WIDTH / 2 -100, SCREEN_HEIGHT / 2 - 120, 15, 220};
    obstacles[2].rect = {SCREEN_WIDTH / 2 + 115, SCREEN_HEIGHT / 2 - 120, 15, 220};
    obstacles[3].rect =  {SCREEN_WIDTH / 2 - 180, SCREEN_HEIGHT / 2+160, 400, 15};
